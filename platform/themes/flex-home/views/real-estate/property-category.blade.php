                            ...
                            @foreach ($properties as $property)
                                <div class="col-6 col-sm-6 col-md-3 colm10" style="margin-bottom: 20px;">
                                    <div class="item">
                                        ...
                                        <div class="description">
                                            <a href="{{ $property->url }}"><h5>{{ Str::title($property->name) }}</h5>
                                                <p class="dia_chi"><i class="fas fa-map-marker-alt"></i> {{ Str::title($property->city->name) }}, {{ Str::title($property->city->state->name) }}</p>
