...
<main class="detailproject bg-white">
    ...
    <div class="container-fluid w90 padtop20">
        <h1 class="titlehouse">{{ Str::title($property->name) }}</h1>
        <p class="addresshouse">
            <i class="fas fa-map-marker-alt"></i> {{ Str::title($property->city_name) }}
        ...
        @auth('account')
            ...
            <div class="mt-3 mb-3">
                <a href="{{ route('property.purchase', $property->id) }}" class="btn btn-success btn-lg">
                    <i class="fas fa-shopping-cart"></i> Buy This Property
                </a>
                <small class="d-block mt-2 text-muted">
                    <i class="fas fa-info-circle"></i> Discounts available for members who lost lucky draws
                </small>
            </div>
            @endif
        @else
            <div class="mt-3 mb-3">
                <a href="{{ route('public.account.login') }}" class="btn btn-primary btn-lg">
                    <i class="fas fa-sign-in-alt"></i> Login to Buy Property
                </a>
            </div>
        @endauth
        <div class="row">
