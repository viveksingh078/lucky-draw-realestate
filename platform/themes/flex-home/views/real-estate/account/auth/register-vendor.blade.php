        ...
        <div class="col-md-10">
            <div class="card login-form">
                <div class="card-body">
                    ...
                    <p class="text-center text-muted">Register as a property vendor to list and manage properties</p>
                    <br>
                    @include(Theme::getThemeNamespace() . '::views.real-estate.account.auth.includes.messages')
                    <br>
                    <form method="POST" action="{{ route('public.account.register.vendor') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="text-center mt-3">
                            <p>Already have an account? <a href="{{ route('public.account.login') }}?type=vendor">Login as Vendor</a></p>
