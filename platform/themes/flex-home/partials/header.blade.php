...
<head>
    ...
    <style>
/* Premium Header Buttons - ULTRA SPECIFIC SELECTORS */
.navbar-nav .nav-item .header-action-btn,
ul.navbar-nav li.nav-item a.header-action-btn,
.main-menu-nav .navbar-nav .header-action-btn {
    padding: 7px 22px !important;
    border-radius: 999px !important;
    background: #ffffff !important;
    color: #1c5b6a !important;
    border: 1.8px solid #1c5b6a !important;
...
.navbar-nav .nav-item .header-action-btn:hover,
.navbar-nav .nav-item .header-action-btn:focus,
ul.navbar-nav li.nav-item a.header-action-btn:hover,
ul.navbar-nav li.nav-item a.header-action-btn:focus,
.main-menu-nav .navbar-nav .header-action-btn:hover,
.main-menu-nav .navbar-nav .header-action-btn:focus,
a.header-action-btn:hover,
a.header-action-btn:focus {
    background: #1c5b6a !important;
    color: #ffffff !important;
    border-color: #1c5b6a !important;
    text-decoration: none !important;
}

/* Icon color on hover - MULTIPLE SELECTORS */
.navbar-nav .nav-item .header-action-btn:hover i,
.navbar-nav .nav-item .header-action-btn:focus i,
ul.navbar-nav li.nav-item a.header-action-btn:hover i,
ul.navbar-nav li.nav-item a.header-action-btn:focus i,
.main-menu-nav .navbar-nav .header-action-btn:hover i,
.main-menu-nav .navbar-nav .header-action-btn:focus i,
a.header-action-btn:hover i,
a.header-action-btn:focus i {
    color: #ffffff !important;
}

/* Override Bootstrap navbar link colors */
.navbar-light .navbar-nav .header-action-btn:hover,
.navbar-light .navbar-nav .header-action-btn:focus {
    color: #ffffff !important;
}
    </style>
                    ...
                    <div class="topbar-right">
                        @if (is_plugin_active('real-estate'))
                            <ul class="topbar-items">
                                <li><a href="tel:9876543210"><i class="fas fa-phone"></i> Helpline Number - 9876543210</a></li>
                            </ul>
                            {{-- COMMENTED - Hide Currency Switcher
                            ...
                            --}}
                        @endif
                        {{-- COMMENTED - Hide Language Switcher
                        ...
                        <div class="collapse navbar-collapse justify-content-end animation" id="navbarSupportedContent">
                            ...
                            <div class="main-menu-content">
                                ...
                                <div class="main-menu-nav d-lg-flex">
                                    ...
                                    {{-- Join Draw & My Orders Menu Links - Only for logged in USERS (not vendors) --}}
                                    @if (auth('account')->check() && auth('account')->user()->isUser())
                                    <ul class="navbar-nav align-items-center ml-2">
                                        <li class="nav-item mx-1">
                                            <a class="header-action-btn" href="{{ route('public.lucky-draws.index') }}" 
                                               onmouseover="this.style.color='#ffffff'; this.querySelector('i').style.color='#ffffff';" 
                                               onmouseout="this.style.color='#1c5b6a'; this.querySelector('i').style.color='#1c5b6a';">
                                                <i class="fas fa-trophy"></i> Join Draw
                                            </a>
                                        </li>

                                        <li class="nav-item mx-1">
                                            <a class="header-action-btn" href="{{ route('public.account.property-purchases') }}"
                                               onmouseover="this.style.color='#ffffff'; this.querySelector('i').style.color='#ffffff';" 
                                               onmouseout="this.style.color='#1c5b6a'; this.querySelector('i').style.color='#1c5b6a';">
                                                <i class="fas fa-shopping-bag"></i> My Orders
                                                @php
                                                    $userPurchaseCount = \Botble\RealEstate\Models\PropertyPurchase::where('account_id', auth('account')->id())->count();
                                                @endphp
                                                @if($userPurchaseCount > 0)
                                                    <span class="badge badge-primary">{{ $userPurchaseCount }}</span>
                                                @endif
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    {{-- Add Property Button - Only for logged in VENDORS --}}
                                        ...
                                        @if (!auth('account')->check())
                                            <ul class="navbar-nav align-items-center ml-2">
                                                ...
                                                <li class="nav-item dropdown mx-1">
                                                    <a class="header-action-btn dropdown-toggle" href="#" id="registerDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                                       onmouseover="this.style.color='#ffffff'; this.querySelector('i').style.color='#ffffff';" 
                                                       onmouseout="this.style.color='#1c5b6a'; this.querySelector('i').style.color='#1c5b6a';">
                                                        <i class="fas fa-user-plus"></i> Register
                                                    </a>
                                                    <div class="dropdown-menu" aria-labelledby="registerDropdown">
                                                        <a class="dropdown-item" href="{{ route('public.account.register') }}?type=user">
                                                            <i class="fas fa-user"></i> Register as User
                                                        </a>
                                                        <a class="dropdown-item" href="{{ route('public.account.register') }}?type=vendor">
                                                ...
                                                <!-- Login Dropdown -->
                                                <li class="nav-item dropdown mx-1">
                                                    <a class="header-action-btn dropdown-toggle" href="#" id="loginDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                                       onmouseover="this.style.color='#ffffff'; this.querySelector('i').style.color='#ffffff';" 
                                                       onmouseout="this.style.color='#1c5b6a'; this.querySelector('i').style.color='#1c5b6a';">
                                                        <i class="fas fa-sign-in-alt"></i> Login
                                                    </a>
                                                    <div class="dropdown-menu" aria-labelledby="loginDropdown">
                                                        <a class="dropdown-item" href="{{ route('public.account.login') }}?type=user">
                                                            <i class="fas fa-user"></i> Login as User
                                                        </a>
                                                        <a class="dropdown-item" href="{{ route('public.account.login') }}?type=vendor">
                                                            <i class="fas fa-briefcase"></i> Login as Vendor
                                                        </a>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div>
                                            @if (is_plugin_active('real-estate'))
                                                <ul class="topbar-items d-block">
                                                    <li class="login-item">
                                                        <a href="tel:9876543210"><i class="fas fa-phone"></i> Helpline Number - 9876543210</a>
                                                    </li>
                                                </ul>
                                                {{-- COMMENTED - Hide Currency Switcher Mobile
                                                @if (count($currencies) > 1)
                                                    <div class="language">
                                                        <div class="language-switcher-wrapper">
                                                ...
                                                --}}
                                            @endif
                                            {{-- COMMENTED - Hide Language Switcher Mobile
                                            {!! Theme::partial('language-switcher') !!}
                                            --}}
                                            @if (is_plugin_active('real-estate'))
                                                <ul class="topbar-items d-block">
                                                    @if (auth('account')->check())
                                                        ...
                                                        @if(auth('account')->user()->isUser())
                                                        <li class="login-item"><a href="{{ route('public.account.property-purchases') }}" rel="nofollow"><i class="fas fa-shopping-bag"></i> <span>My Orders</span>
                                                            @php
                                                                $userPurchaseCount = \Botble\RealEstate\Models\PropertyPurchase::where('account_id', auth('account')->id())->count();
                                                            @endphp
                                                            @if($userPurchaseCount > 0)
                                                        ...
                                                        @if(auth('account')->user()->isVendor())
                                                        <li class="login-item"><a href="{{ route('public.account.properties.create') }}" rel="nofollow"><i class="fas fa-plus-circle"></i> <span>Add Property</span></a></li>
                                                        @endif
