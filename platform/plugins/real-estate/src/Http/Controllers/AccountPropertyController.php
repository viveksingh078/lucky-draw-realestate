...
class AccountPropertyController extends Controller
{
    ...
    {
        // Vendors don't need credits to post
        if (auth('account')->user()->isUser() && !auth('account')->user()->canPost()) {
    ...
    public function store(
        ...
        // Only deduct credits for users, not vendors
        if (auth('account')->user()->isUser() && RealEstateHelper::isEnabledCreditsSystem()) {
