    ...
    <!-- Right Side Of Navbar -->
      <ul class="navbar-nav ml-auto my-2">
        ...
        @else
          ...
          @if (RealEstateHelper::isEnabledCreditsSystem() && auth('account')->user()->isUser())
              <li>
                  <a class="no-underline mr2 black-50 hover-black-70 pv1 ph2 db mr2" style="text-decoration: none; line-height: 32px;" href="{{ route('public.account.recharge') }}" title="Draw Credits">
                      <i class="far fa-credit-card mr1"></i>Draw Credits <span class="badge badge-info">{{ auth('account')->user()->draws_remaining }}</span>
                  </a>
              </li>
          @endif
          ...
          <li>
              <a class="no-underline mr2 black-50 hover-black-70 pv1 ph2 db mr2" style="text-decoration: none; line-height: 32px;" href="{{ route('public.account.lucky-draws') }}" title="Reward Draws">
                  <i class="fas fa-trophy mr1"></i>Reward Draws
              </a>
          </li>
          <li>
              <a class="no-underline mr2 black-50 hover-black-70 pv1 ph2 db mr2" style="text-decoration: none; line-height: 32px;" href="{{ route('public.account.property-purchases') }}" title="My Property Purchases">
                  <i class="fas fa-home mr1"></i>My Properties
              </a>
          </li>
          @endif
          <li>
