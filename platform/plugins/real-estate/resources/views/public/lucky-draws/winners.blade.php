                        ...
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <div class="bg-light rounded p-3 mb-3">
                                    ...
                                    <p class="text-muted mb-2 small">{{ Str::limit($winner['property_name'], 30) }}</p>
                                    <div class="d-flex justify-content-center align-items-center">
                                        <span class="badge bg-success fs-6 px-3 py-2">
                                            ₹{{ number_format($winner['property_value']/100000, 1) }} Lakhs
                                        </span>
                                    </div>
                                </div>
            ...
            <div class="col-12">
                <div class="bg-primary text-white rounded p-5 text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <h2 class="fw-bold">₹{{ number_format($recentWinners->sum('property_value')/10000000, 1) }}Cr+</h2>
                            <p class="mb-0">Properties Won</p>
                        </div>
                        <div class="col-md-4 mb-3">
